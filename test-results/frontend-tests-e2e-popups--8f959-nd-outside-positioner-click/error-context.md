...
- Name: frontend\tests\e2e\popups.spec.ts >> Dialog (centered modal) >> Dialog dismisses via Escape, close button, and outside-positioner click
- Location: frontend\tests\e2e\popups.spec.ts:95:3
