...
- Name: frontend\tests\e2e\analytics.spec.ts >> analytics >> /analytics/inventory renders the expiry tiles + turnover table
- Location: frontend\tests\e2e\analytics.spec.ts:18:3
