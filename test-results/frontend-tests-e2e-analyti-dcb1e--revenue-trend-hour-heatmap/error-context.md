...
- Name: frontend\tests\e2e\analytics.spec.ts >> analytics >> /analytics/sales renders the revenue trend + hour heatmap
- Location: frontend\tests\e2e\analytics.spec.ts:8:3
