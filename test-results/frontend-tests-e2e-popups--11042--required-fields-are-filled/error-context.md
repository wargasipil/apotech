...
- Name: frontend\tests\e2e\popups.spec.ts >> EntityDrawer (slide-over) >> Branches Add → Save is disabled until required fields are filled
- Location: frontend\tests\e2e\popups.spec.ts:34:3
