...
- Name: frontend\tests\e2e\popups.spec.ts >> EntityDrawer (slide-over) >> Customers Add → Save creates a row and closes
- Location: frontend\tests\e2e\popups.spec.ts:18:3
