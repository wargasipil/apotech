...
- Name: frontend\tests\e2e\popups.spec.ts >> Dialog (centered modal) >> F4 on POS opens the customer picker and auto-focuses the search
- Location: frontend\tests\e2e\popups.spec.ts:80:3
