...
func (x *PurchaseReceiptItem) GetMedicineId() string {
	if x != nil {
		return x.MedicineId
	}
	return ""
...
const file_purchasing_iface_v1_receipt_proto_rawDesc = "" +
	...
	"\x16purchase_order_item_id\x18\x03 \x01(\tR\x13purchaseOrderItemId\x12\x1f\n" +
	...
	"\n" +
	"GetReceipt\x12&.purchasing_iface.v1.GetReceiptRequest\x1a'.purchasing_iface.v1.GetReceiptResponse\"\x06\x8a\xb5\x18\x02\x01\x02BFZDgithub.com/apotech/backend/gen/purchasing_iface/v1;purchasingifacev1b\x06proto3"
