...
package healthifacev1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/apotech/backend/gen/health_iface/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "health_iface.v1.HealthService"
)
...
const (
	...
	HealthServicePingProcedure = "/health_iface.v1.HealthService/Ping"
)

// HealthServiceClient is a client for the health_iface.v1.HealthService service.
type HealthServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewHealthServiceClient constructs a client for the health_iface.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_health_iface_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Ping calls health_iface.v1.HealthService.Ping.
...
// HealthServiceHandler is an implementation of the health_iface.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/health_iface.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("health_iface.v1.HealthService.Ping is not implemented"))
}
