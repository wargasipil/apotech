...
type Settings struct {
	...
	// Warn when a medicine's ready_stock in the active warehouse is <= this
...
const file_settings_iface_v1_settings_proto_rawDesc = "" +
	...
	"\x0eUpdateSettings\x12(.settings_iface.v1.UpdateSettingsRequest\x1a).settings_iface.v1.UpdateSettingsResponse\"\x05\x8a\xb5\x18\x01\x01BBZ@github.com/apotech/backend/gen/settings_iface/v1;settingsifacev1b\x06proto3"
