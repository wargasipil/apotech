...
-- +goose Down
ALTER TABLE sales DROP COLUMN tax_invoice_issued_at;
ALTER TABLE sales DROP COLUMN tax_invoice_ppn;
ALTER TABLE sales DROP COLUMN tax_invoice_dpp;
ALTER TABLE sales DROP COLUMN tax_invoice_code;
